...
matrix_bot_sdk_1.LogService.muteModule("Metrics");
...
(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let cryptoStore;
        if (config_1.default.encryption) {
            cryptoStore = new matrix_bot_sdk_1.RustSdkCryptoStorageProvider(path.join(config_1.default.dataPath, "encrypted"));
        }
        // Now create the client
        const client = new matrix_bot_sdk_1.MatrixClient(config_1.default.homeserverUrl, config_1.default.accessToken, storage, cryptoStore);
